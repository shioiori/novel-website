...
namespace NovelWebsite.NovelWebsite.Domain.Services
{
    public class PostService : IPostService
    {
        ...
        Expression<Func<PostEntity, bool>> expValidPost = p => p.Status == 0 && p.IsDeleted == false;
        Expression<Func<PostEntity, bool>> expContainString(string name){
        ...
        public IEnumerable<PostModel> GetListOfValidPosts(string? name)
        {
            ...
            return _mapper.Map<IEnumerable<PostEntity>, IEnumerable<PostModel>>(posts);
        }
