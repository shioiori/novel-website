                            ...
                            <div class="tab-content" style="margin: 1.5rem">
                                <div class="post">
                                    <div class="user-block">
                                        ...
                                        <span class="username">
                                            ...
                                            >
                                                <a
                                                    href="/Admin/Blog/AddOrUpdate?id=@item.Id"
                                                    class="link-primary"
                                                >
                                                ...
                                                |
                                                <a
                                                    href="/Admin/Blog/Delete?id=@item.Id"
                                                >
                                            ...
                                            <a
                                                href="/Admin/Blog/Post?id=@item.Id"
                                                >@item.Title</a
                                            >
                                            <a
                                                href="#"
                                        ...
                                        <span class="description"
                                            ...
                                            Shared public -
                                            @item.CreatedDate.ToString("MMM d,
                                            yyyy")</span
                                        >
                                    </div>
                                    <!-- /.user-block -->
                                ...
                                <div class="post row">
                                    <div class="useravatar col-md-auto">
                                        <a href="#"
                                            ><img
                                                class="img-circle img-bordered-sm col"
                                                src=""
                                                alt="user image"
                                        /></a>
                                    </div>
                                    <div class="user-post col row">
                                        <span class="user-post-title col-md-10">
                                            <a
                                                href="/tin-tuc/@item.Slug-@item.PostId"
                                                >@item.Title</a
                                            >
                                        </span>
                                        <span class="float-end col-md-2">
                                            <span class="control-button">
                                                <i class="fa fa-edit"></i>
                                                <a
                                                    href="/Admin/Post/AddOrUpdatePost?id=@item.PostId"
                                                    >Edit</a
                                                >
                                                |
                                                <i class="fa fa-close"></i>
                                                <a
                                                    href="/Admin/Post/DeletePost?id=@item.PostId"
                                                    >Delete</a
                                                >
                                            </span>
                                        </span>
                                        <span class="user-post-name col-md-12">
                                            Written by @item.User.UserName -
                                            @item.CreatedDate
                                        </span>
                                        <span
                                            class="user-post-content col-md-12"
                                        >
                                            @item.Description
                                        </span>
                                    </div>
